...
/**
 * Implements a solution for a one job scheduling problem. Basically it consists of 2 arrays, (1) for the assignment of machines to operations, (2)
 * the beginning times offsets of operations. Furthermore it declares an error code, indicating if the neighbour operation calculating the solution
 * returned an error.
 * 
 * @author ahaemm
 * 
...
public class SubproblemSolution {
	...
	/**
	 * Integer array storing the assignment of machines to operations. Array indices are operations, entries are machines.
	 */
	int[] machineAssignments;

	/**
	 * Integer array storing the beginning times offsets of operations. Array indices are operations, entries are time offsets from 0.
	 */
	int[] beginningTimesOffsets;

	/**
	 * Might be useful for neighbor solutions to indicate if the neighbor operation was successful. The default value is 0.
	 */
	int errorCode;
	...
	/**
	 * Create a solution object with default error code 0. Deep copy of parameter arrays.
	 * 
	 * @param assignments
	 * @param times
	 */
	...
	/**
	 * Creates a solution object with empty arrays for machine assignments and beginning times, and with default error code 0.
	 * 
	 * @param subproblem
	 */
	...
	/**
	 * Calculates the cost of a solution for the one job scheduling problem. This is the sum of the objective function (completion time or tardiness)
	 * plus machine usage cost.
	 * 
	 * @param solution
	...
	public Bid convertToBid() {
		...
		final Bid bid = new Bid(mSubproblem.getJobID(), this.calcCost(mSubproblem.getObjective()), machineAssignments,
				beginningTimesOffsets);
